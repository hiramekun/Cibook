...
install.packages("Ecdat", repos = "http://cran.r-project.org")
...
# (10) 州ごとのデータでの分析
## miceaddsのインストール
install.packages("miceadds", repos = "http://cran.r-project.org")
...
## ライブラリのインストール（初回のみ）
install.packages("CausalImpact", repos = "http://cran.r-project.org")
